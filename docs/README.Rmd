---
title: "Analysing Gender Representations in American Films from a Network Perspective"
output: 
  github_document:
    dev: png
    toc: true
...
```{r fig.height=4, fig.width=5, message=FALSE, eval = FALSE, dpi=300}
...
```{r, fig.width = 5, fig.height = 4, dpi= 300, eval =FALSE}
...
```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_m('noun', xlimit = 1850, yax = 'noun')
```

```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_f('noun', xlimit = 1850, yax = 'noun')
```
## Common Actions - Verbs

```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_m('verb', xlimit = 1000, yax = 'verb')
```

```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_f('verb', xlimit = 1000, yax = 'verb')
```

## Common Descriptions - Adjectives

```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_m('adj', xlimit = 500, yax = 'adjective')
```

```{r, fig.width = 8, fig.height = 5, dpi= 300, echo=FALSE, warning=FALSE}
ll_bar_f('adj', xlimit = 550, yax = 'adjective')
```
